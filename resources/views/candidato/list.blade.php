    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('candidato.edit', $candidato->id)}}" class="btn btn-primary">
                ...
                <td>
                    <form action="{{ route('candidato.destroy', $candidato->id)}}" method="post">
                        @csrf
                        @method('DELETE')
                        <button class="btn btn-danger" type="submit" onclick="return confirm('Esta seguro de borrar {{$candidato->nombrecompleto}}')">
